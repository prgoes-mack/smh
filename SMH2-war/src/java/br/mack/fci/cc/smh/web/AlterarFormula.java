 ...
 * @author desktop02
 */
@WebServlet(name = "AlterarFormula", urlPatterns = {"/AlterarFormula"})
public class AlterarFormula extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        formulas.AlterarFormula(request.getParameter("nome"), request.getParameter("formula"));
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<a href=\"ListaFormula.jsp\">Voltar</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
